		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="logo-area">
						<a href="#"><img src="img/logo/logo.png" alt="" width="70"
							height="70" /></a>
					</div>
				</div>
									...
									<div class="hd-message-info hd-task-info">
										<div class="skill">
												...
												<div class="lead-content">
													<a href="MyServlet?action=deconnexion">Deconnexion</a>
												</div>
							...
							<ul class="mobile-menu-nav">
								<li><a data-toggle="collapse" data-target="#Charts"
									...
									<ul class="collapse dropdown-header-top">
										...
										<li><a href="MyServlet?action=Scolarite">Scolarité</a></li>
										<li><a href="MyServlet?action=Clubs">Clubs</a></li>
									</ul></li>
								<li><a data-toggle="collapse" data-target="#demoevent"
									href="#">Services</a>
									<ul id="demoevent" class="collapse dropdown-header-top">
										<li><a href="MyServlet?action=DemanderService">Demander
												un service</a></li>
										<li><a href="MyServlet?action=Demandes">Mes demandes</a></li>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
						<li class="active"><a data-toggle="tab" href="#Home"><i
								class="notika-icon notika-house"></i> Acceuil</a></li>
						<li><a data-toggle="tab" href="#mailbox"><i
								class="notika-icon notika-mail"></i> Services</a></li>
